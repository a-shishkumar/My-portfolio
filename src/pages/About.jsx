    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <Card className="relative p-6 bg-blue-500/5 backdrop-blur-md border border-gray-600 shadow-lg hover:shadow-[0_0_25px_rgba(79,149,224,0.5)] transition-shadow duration-300 overflow-hidden shadow-[0_0_20px_rgba(79,149,224,0.3)] flex items-center gap-6">
            <BorderBeam
              size={100}
              duration={8}
              colorFrom="#4f95e0"
            ...
            <div className="flex-[0_0_65%] px-3">
              <h2 className="text-4xl font-bold mb-5 text-[#7EB1E4]">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-6">
                <img
                  ...
                  alt="HTML5"
                  className="w-12 h-12 object-contain rounded-lg bg-blue-500/10 backdrop-blur-sm p-1 shadow-lg shadow-blue-500/50 hover:scale-110 hover:shadow-2xl transition-all duration-300"
                />
                <img
              ...
              <ul className="text-sm sm:text-base text-gray-300 leading-relaxed list-disc list-inside space-y-2">
                <li>
